...
def _group_by_section(items: list[EvidenceItem]) -> dict[str, list[EvidenceItem]]:
    ...
    seo_types = {
        ...
        "INDEXABILITY", "HREFLANG", "OPEN_GRAPH_IMAGE", "OPEN_GRAPH_URL",
        "OPEN_GRAPH_TYPE", "OPEN_GRAPH_SITE_NAME", "TWITTER_CARD_TYPE",
        "TWITTER_CARD_IMAGE", "TWITTER_CARD_SITE", "PAGINATION",
        "AMP_DETECTION", "SCHEMA_ORG_TYPE", "SCHEMA_ORG_NAME",
    }
    metadata_types = {
        ...
        "WEB_APP_CAPABLE", "MOBILE_WEB_APP_CAPABLE", "DNS_PREFETCH", "PRECONNECT",
        "PREFETCH", "PRELOAD", "CONTENT_SECURITY_POLICY", "MSAPPLICATION_TILEIMAGE",
        "MSAPPLICATION_CONFIG", "GEO_META",
    }
    ...
    content_types = {
        ...
        "CONTACT_EMAIL", "CONTACT_PHONE", "CONTENT_VIDEO", "CONTENT_AUDIO",
        "CONTENT_BLOCKQUOTE", "CONTENT_CODE", "CONTENT_DEFINITION_LIST",
        "CONTENT_ADDRESS", "CONTENT_FIGURE_CAPTION",
    }
