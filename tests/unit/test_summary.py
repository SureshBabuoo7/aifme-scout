...
class TestEmptySchema:
    ...
    def test_empty_schema_all_sections_present(self) -> None:
        ...
        assert "# Technology Detected" in result.text
        assert "# SEO Overview" in result.text
        assert "# Metadata Found" in result.text
        assert "# Social Profiles Found" in result.text
        assert "# Content Extraction" in result.text
        assert "# Competitor Analysis" in result.text
...
class TestNoInventedFacts:
    def test_no_invented_facts_empty_schema(self) -> None:
        ...
        assert "Overall Scan Status" in result.text
